# Generated by Django 2.2.5 on 2019-11-19 01:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_default', models.BooleanField(default=False, help_text='whether this webhook is automatically set as default webhook for all newly added owners')),
                ('is_active', models.BooleanField(default=False, help_text='whether notifications are sent to this webhook')),
            ],
        ),
        migrations.AddField(
            model_name='owner',
            name='webhook',
            field=models.ForeignKey(blank=True, default=None, help_text='Webhook used for sending structure notifications', null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='structures.Webhook'),
        ),
        migrations.AddField(
