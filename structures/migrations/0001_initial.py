# Generated by Django 2.2.5 on 2019-11-21 02:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'permissions': (('basic_access', 'Can access this app and view'), ('view_alliance_structures', 'Can view alliance structures'), ('view_all_structures', 'Can view all structures'), ('add_structure_owner', 'Can add new structure owner')),
                'default_permissions': (),
                'managed': False,
            },
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.IntegerField(choices=[(1, 'character'), (2, 'corporation'), (3, 'alliance'), (4, 'faction'), (5, 'other')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('structures_last_sync', models.DateTimeField(blank=True, default=None, help_text='when the last sync happened', null=True)),
                ('structures_last_error', models.IntegerField(choices=[(0, 'No error'), (1, 'Invalid token'), (2, 'Expired token'), (3, 'Insufficient permissions'), (4, 'No character set for fetching alliance contacts'), (5, 'ESI API is currently unavailable'), (6, 'Operaton mode does not match with current setting'), (99, 'Unknown error')], default=0, help_text='error that occurred at the last sync atttempt (if any)')),
                ('notifications_last_sync', models.DateTimeField(blank=True, default=None, help_text='when the last sync happened', null=True)),
                ('notifications_last_error', models.IntegerField(choices=[(0, 'No error'), (1, 'Invalid token'), (2, 'Expired token'), (3, 'Insufficient permissions'), (4, 'No character set for fetching alliance contacts'), (5, 'ESI API is currently unavailable'), (6, 'Operaton mode does not match with current setting'), (99, 'Unknown error')], default=0, help_text='error that occurred at the last sync atttempt (if any)')),
                ('character', models.ForeignKey(blank=True, default=None, help_text='character used for syncing structures', null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='authentication.CharacterOwnership')),
            ],
        ),
        migrations.CreateModel(
            name='Structure',
            fields=[
                ...
                ('last_updated', models.DateTimeField(blank=True, default=None, help_text='date this structure was last updated from the EVE server', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notification_id', models.BigIntegerField(validators=[django.core.validators.MinValueValidator(0)])),
                ('timestamp', models.DateTimeField()),
                ('notification_type', models.IntegerField(choices=[(401, 'MoonminingAutomaticFracture'), (402, 'MoonminingExtractionCancelled'), (403, 'MoonminingExtractionFinished'), (404, 'MoonminingExtractionStarted'), (405, 'MoonminingLaserFired'), (513, 'OwnershipTransferred'), (501, 'StructureAnchoring'), (502, 'StructureDestroyed'), (503, 'StructureFuelAlert'), (504, 'StructureLostArmor'), (505, 'StructureLostShields'), (506, 'StructureOnline'), (507, 'StructureServicesOffline'), (508, 'StructureUnanchoring'), (509, 'StructureUnderAttack'), (510, 'StructureWentHighPower'), (511, 'StructureWentLowPower')])),
                ...
                ('owner', models.ForeignKey(help_text='Corporation that received this notification', on_delete=django.db.models.deletion.CASCADE, to='structures.Owner')),
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='structures.NotificationEntity')),
            ],
            options={
