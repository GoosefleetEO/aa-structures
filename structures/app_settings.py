...
STRUCTURES_FORWARDING_SYNC_GRACE_MINUTES = \
    clean_setting('STRUCTURES_FORWARDING_SYNC_GRACE_MINUTES', 5)
...
STRUCTURES_HOURS_UNTIL_STALE_NOTIFICATION = \
    clean_setting('STRUCTURES_HOURS_UNTIL_STALE_NOTIFICATION', 24)
...
STRUCTURES_NOTIFICATIONS_ARCHIVING_ENABLED = \
    clean_setting('STRUCTURES_NOTIFICATIONS_ARCHIVING_ENABLED', False)

# how to handle notification about NPC attacks
STRUCTURES_REPORT_NPC_ATTACKS = \
    clean_setting('STRUCTURES_REPORT_NPC_ATTACKS', True)
