...
# Dates for fuel expires will be threated as the equal
# within a threshold in seconds
STRUCTURES_NOTIFICATION_FUEL_DATES_EQUAL_THRESHOLD = clean_setting(
    "STRUCTURES_NOTIFICATION_FUEL_DATES_EQUAL_THRESHOLD", 1800
)
