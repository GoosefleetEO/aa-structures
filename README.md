...
- Additional structure notifications generated by the app
  - Configurable fuel notifications to warn about fuel running at in structures and POSes, and which can replace the ESI notifications (BETA)
  - Notifications to inform when structures have been refueled
